 ...
 * 金星
 */
export default class Venus implements Component {
    private readonly name: string = 'Venus-金星';
    
    private scene: THREE.Scene = null; // 场景
    private texture: THREE.Texture = null; // 纹理
    
    private readonly radius: number = Stage.radiusM * 24.8; // 半径
    private readonly trackR: number = Stage.trackIR + Stage.trackM * 1.86; // 轨迹半径
    ...
    private create(): void {
        ...
        _this.instance.rotation.set(0, 2 * Math.PI / 8, 0);
