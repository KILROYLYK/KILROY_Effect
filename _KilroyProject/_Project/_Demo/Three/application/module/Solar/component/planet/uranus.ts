 ...
 * 天王星
 */
export default class Uranus implements Component {
    private readonly name: string = 'Uranus-天王星';

    private scene: THREE.Scene = null; // 场景
    private texture: THREE.Texture = null; // 纹理

    private readonly radius: number = Stage.radiusM * 104.7; // 半径
    private readonly trackR: number = Stage.trackIR + Stage.trackM * 49.57; // 轨迹半径
    ...
    private create(): void {
        ...
        _this.instance.rotation.set(0, 2 * Math.PI / 8 * 6, 0);
