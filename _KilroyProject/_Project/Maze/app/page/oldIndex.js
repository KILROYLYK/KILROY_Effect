...
function main(resources) {
    ...
    //  * @return {void}
    //  */
    // function initCharacter(grid, character) {
    //     const gridWH = maze.grid.wh,
    //         characterWH = character.config.width;
    //
    //     character.object.x = grid.x + gridWH / 2 - characterWH / 2;
    //     character.object.y = grid.y + gridWH / 2 - characterWH / 2;
    // }
}
